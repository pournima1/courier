							...
							foreach($result4 as $row){
                               ...
                               <div class="single-top-post mt-10">
								...
								<div class="top-post-details">
									...
									<ul class="meta">
									<li><a href="#"><span class="lnr lnr-user"></span>2 Views</a></li>
									<li><span class="lnr lnr-heart like"></span>0 Likes</li>
									<li><span class="lnr lnr-bubble comment"></span>06 Comments</li>
									</ul>
									<input type="text" class="post_id" value="<?=$post_id?>" >
									...
									<div class="form-group d-flex flex-row">
										<div class="col-autos">
											<div class="input-group">
												<input class="form-control feedback" style="color:black;" placeholder="feedback" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address'" type="text">


											</div>
										</div>
										<button style="height:36px;margin-top:13px;" class="bbtns send">Send</button>
									</div>
									<!----<p>
									...
									$(document).ready(function(){
										...
										$('.send').click(function(e){
											...
											var feedback = $form.find(".feedback").val();
												...
												if (feedback == '') {
													alert("Please write your feedaback");
												}
												else{

														$.ajax({
												url:'pages/feedbackinsert.php',
												method:'POST',
